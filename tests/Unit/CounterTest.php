...
//use App\Services\Counters\CountService; // ?????? это точно так делается? Абстрактный точно должен быть?
//use Carbon\Carbon;
...
//
//
//    protected function createTestContract(Carbon $issuedDate, float $issuedSum, float $percent = 0, float $penalty = 0, ?Carbon $dueDate = null, $payments = null): Contract
//    {
//        //factory? обращение к базе заблокировано в unit
...
//    {
//        return $this->service->count($contract, $endDate, $this->payments);
//    }
//
//    function test_percents_in_one_day()
//    {
//        $contract = $this->createTestContract(new Carbon('2020-01-01'), 100000, 100);
//        $result = $this->countByService($contract, new Carbon('2021-01-02'));
