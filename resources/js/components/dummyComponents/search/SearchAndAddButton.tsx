...
const SearchAndAddButton = ({label, value = null, required = false, serverAddress, onClickAddButton, setValue, customStyles, disabled = false, onKeyDown = null, className = null, delay = 300}: Props) => {
    ...
    return (
        <div className={styles.main}>
           <EasySearch disabled={disabled} className={className} onKeyDown={onKeyDown} delay={delay} label={label} value={value} required={required} serverAddress={serverAddress} customStyles={customStyles ?? {width: '93%'}} setValue={setValue} />
